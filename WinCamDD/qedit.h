...
EXTERN_C const IID IID_IDxtCompositor;
    ...
    IDxtCompositor // : public IDXEffect S.Yamamoto
    {
    public:
...
EXTERN_C const IID IID_IDxtAlphaSetter;
    ...
    IDxtAlphaSetter // : public IDXEffect S.Yamamoto
    {
    public:
...
EXTERN_C const IID IID_IDxtJpeg;
    ...
    IDxtJpeg // : public IDXEffect S.Yamamoto
    {
    public:
...
EXTERN_C const IID IID_IDxtKey;
    ...
    IDxtKey // : public IDXEffect S.Yamamoto
    {
    public:
